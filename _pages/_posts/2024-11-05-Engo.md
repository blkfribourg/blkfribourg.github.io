...
**Update, September 2026:** The coupon code originally published in this article, `DSHWHL40`, no longer works. Use the current [ENGO discount code DSLWHL_40](/updates/engo-discount-code-40-off/) for **40€ or $40 off, depending on your region**.
{: .notice--warning}
...
Finally, an important note for those considering making the leap: at the time this article was published, I asked Microoled if they could offer a special discount for the community, and they provided a $/€40 promo code for the purchase of a pair of Engo 2 (in tinted or photochromic lenses): <strong>DSHWHL40</strong>. That code has since been replaced; see the [current ENGO discount code](/updates/engo-discount-code-40-off/).
